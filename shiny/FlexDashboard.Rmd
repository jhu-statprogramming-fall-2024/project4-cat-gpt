...
school_info <- read.csv("project4-cat-gpt/data_cleaning/full_school_info_cleaned.csv")
```
...
<div style="display: flex; justify-content: space-between; align-items: center;">
  <img src="ML/5.png" alt="Plot 1" style="height: 300px; width: 480px; margin-right: 10px;">
  <img src="ML/6.png" alt="Plot 2" style="height: 530px; width: 480px;">
</div>
...
```{r}
reddit_posts <- read.csv("reddit_all.csv")
DT::renderDataTable({
  DT::datatable(reddit_posts,
                options = list(autoWidth = TRUE,
                               pageLength = 10,
                               scroller = TRUE,
                               scrollY = '500px'))
...
![](ML/1.png) {height=200px}

### **Figure 2: Hyperparameter Tuning**

![](ML/2.png){width=400px height=330px}

## Col 2

### **Figure 3: SVM Factor Weights**

![](ML/3.png) {width=300px}
